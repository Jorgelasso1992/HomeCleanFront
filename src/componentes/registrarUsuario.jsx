...
export default function RegistarUsuario() {
    ...
    const registro = async (e) => {
        ...
        const usuario = { nombres, correo, contrasena, idAdmin: sessionStorage.getItem('idUsuario') }
        if (nombres === '') {
            Swal.fire({
                icon: 'error',
            ...
            const respuesta = await Axios.post('./usuario/crear', usuario, { headers: { 'autorizacion': token } })
